...
public class Impl_jukan implements GetDataInterface {
    private static final String baseUrl_Jukan = "https://m.jukantv.com/";
    private static final String MovieUrl_Jukan = baseUrl_Jukan+"/dy/index_1_______1.html";
    private static final String EpisodeUrl_Jukan = baseUrl_Jukan+"/dsj/index_1_______1.html";
    private static final String AnimeUrl_Jukan = baseUrl_Jukan+"/Animation/index_1_______1.html";
    private static final String VarietyUrl_Jukan = baseUrl_Jukan+"/Arts/index_1_______1.html";
    private static final String SearchUrl_Jukan = baseUrl_Jukan+"/vod-search-wd-TEMP-p-PAGE.html";
    public static final String NAME = "线路五";
    ...
    public HomeDataBean getHomeData() {
        ...
        try {
            document = Jsoup.connect(baseUrl_Jukan).get();
            ...
            for (Element e: banners) {
                ...
                itemBean.setTargetUrl(baseUrl_Jukan+e.getElementsByTag("a").attr("href"));
            ...
            for (int i = 0; i<elements.size();i++) {
                ...
                for (Element e:elements.get(i).getElementsByTag("li")) {
                    ...
                    movieDetailBean.setTargetUrl(baseUrl_Jukan+e.getElementsByTag("a").get(0).attr("href"));
    ...
    public CategoryDataBean getCategoryData(String url, int page) {
        ...
        try {
            ...
            for(Element e : element.getElementsByTag("a")){
                ...
                tagItemBean.setUrl(baseUrl_Jukan+e.attr("href"));
    ...
    public MovieDetailBean getRealMovieDetail(String url) {
        ...
        try {
            ...
            for (Element e :elements) {
                ...
                bean.setUrl(baseUrl_Jukan+e.getElementsByTag("a").attr("href"));
    ...
    public String getBaseUrl() {
        return baseUrl_Jukan;
    }

    @Override
    public String getMovieUrl() {
        return MovieUrl_Jukan;
    }

    @Override
    public String getEpisodeUrl() {
        return EpisodeUrl_Jukan;
    }

    @Override
    public String getAnimeUrl() {
        return AnimeUrl_Jukan;
    }

    @Override
    public String getVarietyUrl() {
        return VarietyUrl_Jukan;
    }

    @Override
    public String getSearchUrl() {
        return SearchUrl_Jukan;
    }
