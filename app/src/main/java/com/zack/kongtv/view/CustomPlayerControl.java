...
public class CustomPlayerControl
    ...
    public CustomPlayerControl(Context context) {
        super(context);
        mContext = context;
        init();
    }
    ...
    private void init() {
        LayoutInflater.from(mContext).inflate(R.layout.custom_player_controller, this, true);
        ...
        mLock = findViewById(R.id.left_lock);
    ...
    public void onClick(View v) {
        if (v == mCenterStart) {
            ...
            if(isLock){
                mLock.setImageDrawable(getResources().getDrawable(R.drawable.unlock));
                mTop.setVisibility(View.VISIBLE);
                mBottom.setVisibility(View.VISIBLE);
            }else{
                mLock.setImageDrawable(getResources().getDrawable(R.drawable.lock));
                mTop.setVisibility(View.GONE);
                mBottom.setVisibility(View.GONE);
            }
            isLock = !isLock;
    ...
    private void setLockVisible(boolean visible) {
        mLock.setVisibility(visible?VISIBLE:GONE);
        isLockVisible = visible;
        if (visible) {
