...
//                  finish();
            ...
            if (avtInfo.getMediaDuration()!=null && !TextUtils.isEmpty(avtInfo.getMediaDuration()) && avtInfo.getMediaDuration()!="NOT_IMPLEMENTED") {
            ...
            if (avtInfo.getTimePosition()!=null &&!TextUtils.isEmpty(avtInfo.getTimePosition())) {
